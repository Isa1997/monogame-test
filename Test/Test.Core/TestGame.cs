...
namespace Test.Core
{
    ...
    public class TestGame : Game
    {
        ...
        private SettingsManager<TestLeaderboard> leaderboardManager;
        ...
        public TestGame()
        {
            ...
            settingsManager = new SettingsManager<TestSettings>(storage);
            Services.AddService(typeof(SettingsManager<TestSettings>), settingsManager);

            leaderboardManager = new SettingsManager<TestLeaderboard>(storage);
            Services.AddService(typeof(SettingsManager<TestLeaderboard>), leaderboardManager);
